...
\section{Introduction}
	...
	Dans un premier temps, nous décrirons dans la Section \ref{sec:projet}, notre projet, ses objectifs et la problématique scientifique que nous traiterons, notre travail et à travers ce rapport.
	Nous décrirons, dans la Section \ref{sec:etatart}, le cadre de comparaison que nous avons mis au point pour l'adaptation dynamiques de jeux à leurs joueurs pour notre état de l'art. 
...
\section{Etat de l'art}\label{sec:etatart}
	...
	\subsection{Rédaction d'un état de l'art}\label{sec:eda}
		...
		Nous avons appliqué ce cadre à des approches que nous avons étudiées.
	...
	\subsection{Lecture de l'état de l'art}
		...
		\subsubsection{Application du cadre}
			...
			Sans quoi, le jeu ne pourrait pas s'adapter correctement au joueur et impacter négativement son expérience de jeu et son niveau d'intérêt pour le jeu.
