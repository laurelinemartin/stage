...
\title{Rapport de Stage\\ Master 2 Data Managment in a digital world - DataScale}
...
\begin{tabular}{p{4cm}p{4cm}p{8cm}}
	\hspace*{-1cm}
	Mme. Zoubida KEDAD & Enseignante-chercheure & Laboratoire DAVID\smallskip\\
	\hspace*{-1cm}
	M. Philippe PUCHERAL & Enseignant-chercheur & INRIA
\end{tabular}
\begin{center}
	\textbf{Encadrants :}
\end{center}
\begin{tabular}{p{4cm}p{4cm}p{8cm}}
	\hspace*{-1cm}
	Mme. Viviane GAL & Docteur - Ingénieur & Equipe \textit{Interactivité pour lire et jouer - ILJ}\smallskip\\
	\hspace*{-1cm}
...
\section{Introduction}
	...
	Ce seront les émotions du joueurs qui influenceront le jeu et ses événements. 
	...
	Puis, dans la Section \ref{sec:projet}, nous décrirons le projet, ses objectifs et la problématique scientifique que nous traiterons notre travail et à travers ce rapport.
...
\section{Cadre du projet}\label{sec:projet}
	...
	\subsection{Motivations et objectif du projet}\label{sec:objectif}
		...
		La réponse adaptée du jeu à l'état émotionnel de son joueur devra se faire sous la forme d'événments dans le jeu.
		Les événemnts particularisés par rapport à l'état émotionnel du joueur devront soit :
		\begin{itemize}
	...
	\subsection{Définitions et sujets connexes}\label{sec:connexe}
		...
		Elle est la réponse à un événement, à un stimulus.
		L'ensemble des émotions est très restreint.
		Il se composent, selon les définitions de quatre à huit émotions.
		...
		Cela nous permet aussi de rester assez vastes sur les possibilité de reconnaissance de notre jeu.\par
		...
		Tout au long du rapport, nous allons aborder ces sujets qui n'entre pas directemnt dans le cadre de la solution que nous apportons mais qui sont essentiels pour la compréhension du sujet de notre projet et de la contribution de notre solution.
...
\section{Etat de l'art}\label{sec:etatart}
	...
	\subsection{Application du cadre}
		...
		C'est pour cette raison que nous pensons qu'il est préférable d'utiliser un algorithme d'apprentissage profond non-supervisé pour la reconnaissance des états émotionnels. 
		...
		De plus, cela implique d'envisager absolument tous les états du jeu possibles, toutes les actions possibles du joueur et d'associer un état émotionnel por chacque intersection.
