...
\section{Présentation du laboratoire CEDRIC}\label{sec:cedric}
	\begin{center}
		\includegraphics[scale=0.4]{../include/logo-cedric.PNG}\\
	\end{center}
...
\section{Cadre du projet}\label{sec:projet}
	...
	\subsection{Motivations et objectif du projet}\label{sec:objectif}
		Avec le jeu pervasif, il est possible de créer une grande immersion et une plus grande implication du joueur pour le jeu contrairement à d'autres types de jeux (jeux vidéos, jeux de sociétés, etc.).
