...
\section{Approche suivie et solution proposée}
	\subsection{Découverte du projet}
		...
		Au fil de mes recherches, j'ai construit un tableau synthétique des approches en utilisant plusieurs colonnes-critères afin que la lecture et l'explication de chacune d'entre elle soit plus simple.\par
