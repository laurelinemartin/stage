...
\section{Approche suivie et solution proposée}
	...
	\subsection{Rédaction d'un état de l'art}
		...
		Je me suis inspiré des colones de ce tableau pour faire des critères plus ciblé. Il m'aura aussi aidé à rédiger le tableau comparatif de l'état de l'art.
...
\section{Annexe 2 - Construction d’un modèle utilisateur pour l’adaptation d’un jeu pervasif à son utilisateur – État de l’art}
